...
public class CraftingParticle : MonoBehaviour
{
    ...
    [SerializeField] private Robot assignedRobot;
    [SerializeField] private GameObject craftingParticle;
    ...
    {
        if (craftingParticle.activeSelf == assignedRobot.IsLookingAtPlayer)
            craftingParticle.SetActive(!assignedRobot.IsLookingAtPlayer);
    }
}
